/**
 * Mock for NumeraDesignSystem - used in tests
 */
export const NumeraDesignSystem = {
  ...
  shadows: {
    ...
    lg: { shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.15, shadowRadius: 15, elevation: 5 },
  },
  borderRadius: { sm: 4, md: 8, lg: 12, xl: 16, full: 9999 },
  layout: { containerPadding: 20, sectionSpacing: 32, cardPadding: 16 },
};